...
namespace GoldDashboard
{
    ...
    public class ApplicationUserStore : UserStore<AppUsers>
    {
        public ApplicationUserStore(AppDb context) : base(context)
        {
        }
    }
    public class ApplicationUserManager : UserManager<AppUsers>
    {
        public ApplicationUserManager(IUserStore<AppUsers> store) : base(store)
        {
        }

        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context)
        {
            var manager = new ApplicationUserManager(new UserStore<AppUsers>(context.Get<AppDb>()));
    ...
    public class ApplicationRoleManager : RoleManager<IdentityRole>
    {
        ...
        public static ApplicationRoleManager Create(IdentityFactoryOptions<ApplicationRoleManager> options, IOwinContext context)
        {
            ...
            var appRoleManager = new ApplicationRoleManager(new RoleStore<IdentityRole>(context.Get<AppDb>()));
